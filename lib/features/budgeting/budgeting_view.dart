...
class _BudgetingViewState extends State<BudgetingView> {
                ...
                return Column(
                  children: [
                    ...
                    const ImportOptionCard(
                      ...
                      description:
                          'Explain to Artificial Intelligence your desired budget to have its preset autogenerated',
                      isEnabled: false,
                    ),
                    const SizedBox(height: AppTheme.spacingMd),
                    ImportOptionCard(
        ...
        children: [
          ...
          Expanded(
            child: currentTemplate != null
                ...
                : Text(
                    'You don\'t have an active budget. Create a new budget or import a previous one to get started.',
                    style: AppTheme.bodyMedium
                        .copyWith(color: context.colors.textSecondary),
                  ),
          ),
            ...
            if (appContext.currentTemplate != null)
              Expanded(
                child: ElevatedButton(
                  ...
                  child: const Text('Update The Current Budget'),
                ),
              ),
          ],
        ),
                ...
                if (context.mounted) {
                  if (success) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                            viewModel.errorMessage ?? 'Failed to save Budget'),
                        backgroundColor: context.colors.error,
                      ),
                    );
                  }
  ...
  void _launchBudgetingGuide() async {
    final uri = Uri.parse('${Env.docsBaseUrl}#creating-budget');
